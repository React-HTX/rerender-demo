...
export default function InfiniteLoop() {
  ...
  const [post, setPost] = useState<Post | null>(fallbackData[0]);
  ...
  // 🚨 INFINITE LOOP DEMO — DON'T DO THIS
  /*
  useEffect(() => {
    console.log("💣 This effect causes an infinite loop");
    setLiked(true); // 👈 causes re-render every time
